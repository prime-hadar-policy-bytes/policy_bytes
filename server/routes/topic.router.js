...
//     pool.query(queryText1, [topic.contributor1FirstName,
//     topic.contributor1LastName, topic.bio1, topic.photo1, topic.contributor1DbId]).then((result) => {
...
//     pool.query(queryText2, [topic.contributor2FirstName,
//     topic.contributor2LastName, topic.bio2, topic.photo2, topic.contributor2DbId]).then((result) => {
...
//     pool.query(queryText, [topic.topicTitle, topic.topicPremise, topic.topicCommonGround, 
//         topic.topicSummary, topic.topicDBId]).then((result) => {
//     console.log('successfully posted topic')
//     res.sendStatus(200);

//     let queryText3 = `UPDATE "proposal" SET "proposal" = $1 WHERE "id" = $2;`

//     pool.query(queryText3, [topic.proposal1, topic.contributor1DbId]).then((result) => {
...
//     pool.query(queryText4, [topic.proposal2, topic.contributor2DbId]).then((result) => {
...
//             contributor = topic.contributor2DbId
//         }
//         pool.query(queryText5, [contributor, keyClaimData[2], keyClaimData[0]]).then((result) => {
//         console.log("successfully posted key claim");
//         res.sendStatus(200);
...
//             pool.query(queryText6, [contributor, streamClaimData[2], streamClaimData[3], stream_order]).then((result) => {
//             console.log("successfully posted stream claim");
// })
